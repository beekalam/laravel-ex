<!DOCTYPE html>
  ...
  <head>
    ...
    <title>{{ config('Contacts.title') }} Admin</title>
  
   <link href="//maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css" rel="stylesheet">
   <link href="{{ asset('datatables/media/css/dataTables.bootstrap.min.css') }}" rel="stylesheet">
 ...
 <nav class="navbar navbar-default">
   <div class="container-fluid">
     <div class="navbar-header">
       ...
       <a class="navbar-brand" href="#">{{ config('Contacts.title') }} Admin</a>
     </div>
